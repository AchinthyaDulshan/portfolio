  ...
  return (
    ...
    <section id='hero'>
      <div className='grid justify-items-center content-center gap-5 lg:gap-7 min-h-dvh font-heading '>
        ...
        {/* Hi, name text  */}
        <h3 className='text-sm md:text-base lg:text-lg border border-gray-400 px-4 py-1 rounded-full bg-gradient-to-r from-gray-500 to-gray-700 font-semibold h-fit w-fit mx-auto'>Hi, I'm {heroContent.myName} 👋</h3>
        ...
        <div className='grid grid-cols-2 gap-2 mt-10 text-sm lg:text-base'>
          {/* connect button  */}
          <a href="#contact" className='rounded-lg border text-gray-400 border-gray-400 font-text font-medium py-2 px-3 flex justify-center items-center'>Connect</a>
          {/* Download CV button  */}
          <a href={heroContent.cvLink} className='rounded-lg border bg-gray-200 border-gray-400 font-text font-medium py-2 px-3 flex justify-center items-center'>Get My CV</a>
        </div>
      </div>
    </section>
  )
